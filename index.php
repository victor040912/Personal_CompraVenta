...
<head>
    ...
    <meta charset="utf-8" />
    <title>Victor Quispe | Acceso </title>
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="assets/images/LogoA.png" alt="" height="150">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Controlar los ingresos no es limitarse, es garantizar que cada esfuerzo 
                                                                                         y que cada decisión contribuya al crecimiento del 
                                                                                        negocio en el largo plazo"</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Una auditoría de gastos eficiente permite detectar 
                                                                                        errores a tiempo y garantizar un crecimiento sostenible 
                                                                                        en la empresa "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Gestionar correctamente los gastos es la clave para mantener
                                                                                         la estabilidad y aprovechar al máximo cada ingreso "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end carousel -->
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Inicia sesion para ingresar al portal de ventas</p>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Create by <i class="mdi mdi-heart text-danger"></i> Victor Quispe Quiroz
                            </p>
                        </div>
                    </div>
                </div>
